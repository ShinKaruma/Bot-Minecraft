...
from interactions import SlashContext, ModalContext, Guild, ContextMenuContext
...
class LocalisedMessages:
    ...
    async def send_message(self, ctx: SlashContext|ModalContext|ContextMenuContext, key, **kwargs):
